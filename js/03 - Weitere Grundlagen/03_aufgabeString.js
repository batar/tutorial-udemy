...
console.log(shopping.substr(0, 17) + shopping.substr(pos+3));
console.log(shopping.slice(0,17) + shopping.slice(pos+3));
...
let shoppinText = shopping.replace("+++", "")
                  .replace(",", "\n -")
                  .replace(",", "\n -")
                  .replace(",", "\n -")
